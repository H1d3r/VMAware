...
| <img src="assets/language_icons/rust-logo-512x512.png" width="20"> Rust | [ссылка](https://github.com/MarcelDev/vmaware-rs) | Отличный API, хорошо протестирован, активно поддерживается | [Marcel](https://github.com/MarcelDev) |
